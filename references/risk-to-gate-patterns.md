...
| Documentation tracks execution status | Summary says Done while detail still says Ready or acceptance remains unchecked. | Require state synchronization at completion and audit before commit. | Iteration/Git SOP |
